...
<h3 align='center'>@cluesurf/size</h3>
<p align='center'>
...
```
pnpm add @cluesurf/size
yarn add @cluesurf/size
npm i @cluesurf/size
```
...
```ts
import size from '@cluesurf/size'
...
[test.ts](https://github.com/cluesurf/size.js/blob/make/test.ts) file,
